export const load = {
    ...
    assets: () => {
        ...
        loadSprite("sky-background_0","./assets/Sky_Background_0.png"),
        loadSprite("sky-background_1","./assets/Sky_Background_1.png"),
        loadSprite("sky-background_2","./assets/Sky_Background_2.png"),
